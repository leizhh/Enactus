...
storys = [
    {1:u'给',2:u'你',3:u'的备注:十二<br>朋友十二画,家人十二画<br>',4:u'创行',5:u'十二画<br>十二的名字叫做难忘'},
    {1:u'很多年后<br>我都记得百团大战那天<br>我遇见了',2:u'你',3:u'<br>和我扑通扑通的心'},
    {1:u'我想成立一个',2:u'项目',3:u'，<br>受众只有',4:u'你',5:u'一个，<br>用一生的时间<br>提高',6:u'你',7:u'的生活质量'},
    ...
    {1:u'<br>我就是喜欢',2:u'你',3:u'看不惯我<br>却不得不陪我<br>一起加',4:u'创行',5:u'的样子'},
